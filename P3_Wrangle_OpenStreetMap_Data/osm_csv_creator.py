...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 18 13:02:07 2017
...
from osm_streets_audit import mapping, update_street_type
from osm_postcode_clean import clean_postcode, audit_postcode
from osm_amenities_audit import amenity_mapping, update_amenity

OSM_PATH = "amsterdam_netherlands.osm"
            ...
            if child.tag == 'tag':
                ...
                if problem: 
                    ...
                    if child.attrib['k'] == "addr:street":
                        tag ['value'] = update_street_type(child.attrib['v'], mapping)
                    else:
                        tag ['value'] = child.attrib['v'] 
                    ...
                    if child.attrib['k'] == "addr:postcode":
                        if not clean_postcode(child.attrib['v']):
                            continue 
                        else:
                            tag ['value'] = clean_postcode(child.attrib['v']) 
                    else:
                        tag ['value'] = child.attrib['v']                       
                ...
                if problem: 
                    ...
                    if child.attrib['k'] == "addr:postcode":
                        if not clean_postcode(child.attrib['v']):
                            ...
                            way_tag ['value'] = clean_postcode(child.attrib['v'])
                    else:
                        way_tag ['value'] = child.attrib['v']                       
